package level1;// 프로그래머스 모바일은 개인정보 보호를 위해 고지서를 보낼 때 고객들의 전화번호의 일부를 가립니다.
...
public class level1_4 {
    ...
    public static void main(String[] args) {
        ...
        String x = sc.nextBigInteger().toString();
        String result = solution(x);
        System.out.println(result);
    }
}

//정규식을 쓰면 간단하지만 정규식 찾기가 쉽지 않음
//char array를 만들어 바꾸는 방법도 괜찮을듯
